                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Create Review</h5>
                                            <span>Create a new customer review for your business</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Create New Customer Review</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                        ...
                                        <form method="POST" action="{{ route('reviews.store') }}" class="forms-sample">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg">
                                                    ...
                                                    <input type="text" class="form-control" id="customer-name" name="name" placeholder="Enter customer full name">
                                                </div>
                                                
                                                <div class="form-group col-lg">
                                                    <label for="customer-email">Email</label>
                                                    <input type="text" class="form-control" id="customer-email" name="email" placeholder="Enter customer email">
                                                </div>
                                            </div>
