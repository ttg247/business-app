                                        ...
                                        <table id="advanced_table" class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('bookings/'.$opportunity->id.'/edit') }}"><i class="ik ik-edit f-16 mr-12 text-success"></i></a>
                                                        <a href="{{ url('bookings/delete/'.$opportunity->id) }}"><i class="ik ik-trash-2 f-16 text-red"></i></a>
                                                    </td>
                                                    <td></td>
                                                </tr>
                                                @endforeach
