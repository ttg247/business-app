                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ url('leads.store') }}" class="forms-sample" method="POST">
                                            @csrf
                                            @method('post')
                                            <div class="form-group">
                                                <label for="lead-name">Name</label>
                                                <input type="text" class="form-control" id="lead-name" name="name" placeholder="Enter your lead's full name">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="lead-email">Email address</label>
                                                        <input type="email" class="form-control" id="lead-email" name="email" placeholder="Enter your lead's email address">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="lead-phone">Phone Number</label>
                                                        <input type="tel" class="form-control" id="lead-phone" name="phone" placeholder="Enter your lead's phone number">
                                                    </div>
                                                </div>
                                            </div>
